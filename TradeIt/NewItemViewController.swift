...
class NewItemViewController: UIViewController {
    ...
    lazy var leftButton: UIButton = {[unowned self] in
        ...
        button.addTarget(self, action: #selector(NewItemViewController.leftButtonClicked(_:)), for: .touchUpInside)
        return button
        }()
    ...
    lazy var rightButton: UIButton = {[unowned self] in
        ...
        button.setTitleColor(UIColor.white, for: .normal)
        button.titleLabel?.font = UIFont(name: "ChalkboardSE-Regular", size: 22)
        button.addTarget(self, action: #selector(NewItemViewController.rightButtonClicked(_:)), for: .touchUpInside)
        return button
        }()
...
extension NewItemViewController: UIGestureRecognizerDelegate {
